    ...
    <div className="space-y-3 w-full animate-in fade-in slide-in-from-bottom-2 duration-500 delay-50">
      ...
      <div className="github-calendar-wrapper w-full">
        <ActivityCalendar
          ...
          labels={{
            totalCount: `{{count}} ${ui.activity.githubContribution.toLowerCase()}`,
          }}
        />
      </div>
...
export default function ActivityGridClient({
  githubUsername,
  activityItems,
  githubActivity,
}: {
  ...
  const showGitHub = Boolean(githubUsername && githubActivity && githubActivity.length > 0);
  ...
  return (
    <section className="py-16 border-t border-border/50 space-y-8 w-full overflow-hidden">
      ...
      {showGitHub && githubActivity && githubUsername && (
        <GitHubSection
      ...
      <style jsx global>{`
        ...
        .github-calendar-wrapper > article > div {
          width: 100% !important;
          max-width: none !important;
        }
